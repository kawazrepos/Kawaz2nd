...
class RegistrationModelTests(TestCase):
    ...
    prof_info = {'remarks': 'remarks'}
    all_info = dict(user_info, **prof_info)
    ...
    def test_profile_creation(self):
        ...
        profile = RegistrationProfile.objects.create_profile(new_user, **self.prof_info)
        ...
        self.assertEqual(profile.remarks, self.prof_info['remarks'])
    ...
    def test_user_creation(self):
        ...
        self.assertEqual(RegistrationProfile.objects.get(user__username=new_user.username).remarks, self.prof_info['remarks'])
    ...
    def test_user_creation_email(self):
        ...
        new_user = RegistrationProfile.objects.create_inactive_user(site=Site.objects.get_current(),
                                                                    **self.all_info)
        # One for registration, one for notification
    ...
    def test_valid_activation(self):
        ...
        new_user = RegistrationProfile.objects.create_inactive_user(site=Site.objects.get_current(),
                                                                    **self.all_info)
        profile = RegistrationProfile.objects.get(user=new_user)
        activated = RegistrationProfile.objects.activate_user(profile.activation_key, Site.objects.get_current())
    ...
    def test_expired_activation(self):
        ...
        profile = RegistrationProfile.objects.get(user=new_user)
        activated = RegistrationProfile.objects.activate_user(profile.activation_key, site=Site.objects.get_current())
    ...
    def test_activation_invalid_key(self):
        ...
        """
        self.failIf(RegistrationProfile.objects.activate_user('foo', site=Site.objects.get_current()))
    ...
    def test_activation_already_activated(self):
        ...
        new_user = RegistrationProfile.objects.create_inactive_user(site=Site.objects.get_current(),
                                                                    **self.all_info)
        profile = RegistrationProfile.objects.get(user=new_user)
        RegistrationProfile.objects.activate_user(profile.activation_key, site=Site.objects.get_current())

        profile = RegistrationProfile.objects.get(user=new_user)
        self.failIf(RegistrationProfile.objects.activate_user(profile.activation_key, site=Site.objects.get_current()))
    ...
    def test_activation_nonexistent_key(self):
        ...
        self.failIf(RegistrationProfile.objects.activate_user(invalid_key, site=Site.objects.get_current()))
