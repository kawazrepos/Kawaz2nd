...
class RegistrationModelTests(TestCase):
    ...
    def test_profile_creation(self):
        ...
        self.assertEqual(profile.activation_key, RegistrationProfile.UNTREATED)
    ...
    def test_unexpired_account(self):
        ...
        RegistrationProfile.objects.accept_user(profile, None)
    ...
    def test_expired_user_deletion(self):
        ...
        for registration_profile in RegistrationProfile.objects.all():
            RegistrationProfile.objects.accept_user(registration_profile, None)
