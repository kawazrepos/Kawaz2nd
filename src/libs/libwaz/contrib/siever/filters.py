...
class ChoiceFilter(Filter):
    ...
    def __init__(self, choices=[], *args, **kwargs):
        if not '' in dict(choices).keys():
            choices = [(u'', _('All'))] + list(choices)
        super(ChoiceFilter, self).__init__(choices=choices, *args, **kwargs)
...
class DateRangeFilter(ChoiceFilter):
    ...
    def __init__(self, allow_future=False, allow_past=True, *args, **kwargs):
