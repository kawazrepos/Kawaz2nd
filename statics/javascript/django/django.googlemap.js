...
(function($){
	$.fn.googlemap = function(settings){
		...
		settings = jQuery.extend(true, {
			...
			query: {
				submit: {
					src:		"/image/django-locationfield/query-submit-image.png",
					alt:		"入力された住所から地図に適用する",
					title:		"入力された住所から地図に適用する"
				},
				loading: {
					src:		"/image/django-locationfield/query-loading-image.gif",
					alt:		"検索中..."
				},
				error: {
					src:		"/image/django-locationfield/query-error-image.png",
					alt:		"住所から地図へのマッピングでエラーが発生しました",
					title:		"住所から地図へのマッピングでエラーが発生しました"
				}
			},
			visibility: {
				show: {
					src:		"/image/django-locationfield/visibility-show-image.png",
					alt:		"地図を表示する",
					title:		"地図を表示する"
				},
				hide: {
					src:		"/image/django-locationfield/visibility-hide-image.png",
					alt:		"地図を隠す",
					title:		"地図を隠す"
				}
			},
		...
		function addGeocodeButton($query){
			...
			$query.after($('<br />')).after('<small>Tabキーで地図に住所を適用することができます</small>').after($error).after($loading).after($submit);
			// Create Geocoder
